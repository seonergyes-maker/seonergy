...
import { Code, TrendingUp, Palette, Megaphone } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    link: "/servicios/seo-estrategico",
  },
  {
    icon: Code,
  ...
  },
  {
    icon: Megaphone,
    title: "Marketing & Ads",
    description: "Campañas enfocadas a resultados. Google Ads, Meta Ads y medición de leads con landing pages que convierten.",
    features: ["Google Ads", "Meta Ads", "Landing Pages"],
    link: "/servicios/marketing-ads",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              <Link href={service.link} data-testid={`link-service-${service.title.toLowerCase().replace(/\s+/g, '-')}`}>
