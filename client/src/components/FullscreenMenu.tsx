...
const menuItems = [
  { label: "Inicio", href: "/", number: "01", description: "Comienza aquí" },
  ...
  { label: "Analiza tu Web", href: "/analiza-tu-web", number: "05", description: "Análisis SEO gratuito" },
  { label: "Contacto", href: "/contacto", number: "06", description: "Hablemos" },
];
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <MessageCircle className="w-5 h-5 opacity-50 group-hover:opacity-100" />
                      <span className="font-medium">+34 604 83 92 62</span>
                    </a>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-3 md:gap-4">
                    <a
                      href="https://www.instagram.com/seonergy.es/"
                      target="_blank"
                      rel="noopener noreferrer"
